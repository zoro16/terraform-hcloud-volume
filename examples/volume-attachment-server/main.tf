...
module "vol_attach" {
  ...
  create_volume_attachment    = true
  volume_attachment_volume_id = module.vol.volume_id
  volume_attachment_server_id = module.sv.server_id
  volume_attachment_automount = true
}
